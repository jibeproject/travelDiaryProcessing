...
# ################################################################# #
library(tidyverse)
# mandatory_trips <- read.csv("Cdata/Melbourne/DOT_VISTA/processed/mandatory_trips.csv",stringsAsFactors = TRUE)
mandatory_trips <- read_csv("data/Melbourne/DOT_VISTA/processed/mandatory_trips.csv",col_types = cols(...1 = col_skip()))
