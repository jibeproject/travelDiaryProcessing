...
beta_lc_matrix <- as.matrix(data.frame(
  asc                     = c(1, 0, 0, 0),
  p.age_group_agg_15_24   = c(1, 0, 0, 0),
  p.age_group_agg_25_39   = c(1, 0, 0, 0),
  p.female_FALSE          = c(1, 0, 0, 0),
  p.occupation_worker     = c(1, 0, 0, 0),
  hh.cars_gr_0            = c(1, 0, 0, 0),
  hh.cars_gr_1            = c(1, 0, 0, 0),
  hh.cars_gr_2            = c(1, 0, 0, 0), 
  hh.size                 = c(1, 0, 0, 0),
  hh.children5to9_yes     = c(1, 0, 0, 0),
  hh.children10to14_yes   = c(1, 0, 0, 0),
  t.departureTime_day_TRUE= c(1, 0, 0, 0),
  t.full_purpose_HBR      = c(1, 0, 0, 0),
  t.full_purpose_HBS      = c(1, 0, 0, 0),
  #t.full_purpose_HBA      = c(1, 0, 0, 0),
  #t.full_purpose_HBO      = c(1, 0, 0, 0),
  # hh.cars_agg             = c(1, 0, 0, 0),
  # Uncomment the lines below and replace 0 with the desired values
  # p.age_group_agg_5_14    = c(1, 0, 0, 0),
  # p.age_group_agg_40_54   = c(1, 0, 0, 0),
  # p.age_group_agg_55      = c(1, 0, 0, 0),
  # p.occupation_student  = c(1, 0, 0, 0),
  # hh.cars_gr_3          = c(1, 0, 0, 0),
  # hh.carsPerAdult       = c(1, 0, 0, 0),
  # hh.children             = c(1, 0, 0, 0),
  # hh.children_yes       = c(1, 0, 0, 0),
  row.names = class
))
...
apollo_lcPars = function(apollo_beta, apollo_inputs){
  ...
  lc = names(apollo_beta)[endsWith(names(apollo_beta),"_c1")|
                            endsWith(names(apollo_beta),"_c2")|
                            endsWith(names(apollo_beta),"_c3")|
                            endsWith(names(apollo_beta),"_c4")]
  ...
  for (var in vars) {
    ...
    lcpars[[var]] = list(var1,var2,var3,var4)
   
  }
  
  V=list()
  
  for(s in c("c1","c2","c3","c4")){
  ...
  classAlloc_settings = list(
    classes      = c(Class_c1=1, Class_c2=2, Class_c3=3, Class_c4=4), 
    utilities    = V
  )
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate_settings$bootstrapSE=TRUE"){
  ...
  availa[["c2"]] = list(carD=av_carD, carP=1,pt=1, bike=1,walk=1)
  availa[["c3"]] = list(carD=av_carD, carP=1,pt=1, bike=1,walk=1)
  availa[["c4"]] = list(carD=av_carD, carP=1,pt=1, bike=1,walk=1)
...
expectedValue = expectedValue%>%
  ...
  left_join(database,by=c("ID"="t.ID"))%>%
  select(-c(t.m_main_apollo))
