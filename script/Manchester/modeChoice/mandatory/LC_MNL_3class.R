...
trips =  trips%>% within({ 
  ...
  walk_stressLinkLogDistance = walk_stressLink * walk_logDist
...
# ################################################################# #
outputDir <- "result/Manchester/mandatory/lcmnl_final/"
scenario = "lcmnl_v22.4"
...
beta_av_matrix =  as.matrix(data.frame(asc                     = c( 1     , 1     , 1    , 1      ,1),
                                       ...
                                       stressLinkLogDistance              = c( 0     , 0     , 0     , 1     ,1),
                                       stressJctDistance               = c( 0     , 0     , 0     , 0     ,1),
...
#                                                     "ptav.pt_asc_c2","carPav.carP_asc_c2","carPav.carP_time_c2","ptav.pt_time_c2",
#                                                     "bikeav.bike_asc_c3","bikeav.bike_logDist_c3","bikeav.bike_stressLinkLogDistance_c3",
#                                                     "bikeav.bike_stressJctDistance_c3","bikeav.bike_shannon_c3") == FALSE]

# apollo_beta = apollo_beta[names(apollo_beta) %in% c("bikeav.bike_asc_c1","bikeav.bike_logDistkm_c1",
#                                                     "ptav.pt_asc_c2","carPav.carP_asc_c2",
#                                                     "carPav.carP_time_c2","ptav.pt_time_c2",
#                                                     "carDav.carD_asc_c3","carDav.carD_time_c3") == FALSE]

# apollo_beta = apollo_beta[names(apollo_beta) %in% c("carDav.carD_asc_c2","carDav.carD_time_c2",
#                                                     "bikeav.bike_asc_c3","bikeav.bike_logDistkm_c3","bikeav.bike_stressLink_c3","bikeav.bike_stressJct_c3","bikeav.bike_shannon_c3",
#                                                     "ptav.pt_asc_c3","ptav.pt_time_c3") == FALSE]


apollo_beta = apollo_beta[names(apollo_beta) %in% c("carDav.carD_asc_c3","carDav.carD_time_c3",
                                                    "carPav.carP_asc_c2","carPav.carP_time_c2",
                                                    "ptav.pt_asc_c2","ptav.pt_time_c2",
                                                    "bikeav.bike_asc_c1","bikeav.bike_logDistkm_c1",
                                                    "bikeav.bike_stressLinkLogDistance_c1","bikeav.bike_stressJctDistance_c1",
                                                    "bikeav.bike_shannon_c1") == FALSE]
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate_settings$bootstrapSE=TRUE"){
  ...
  availa = list()
  availa[["c1"]] = list(carD=av_carD, carP=1,pt=1, bike=0,walk=1)
  availa[["c2"]] = list(carD=av_carD, carP=0,pt=0, bike=1,walk=1)
  availa[["c3"]] = list(carD=0, carP=1,pt=1, bike=1,walk=1)
...
#model=apollo_loadModel("lcmnl_v14.2")
