...
trips =  trips%>% within({ 
  ...
  walk_time = ((walk_dist/1000)/4.0)*60
  bike_time = ((walk_dist/1000)/12.5)*60
  walk_logTime = log(((walk_dist/1000)/4.0)*60)
  bike_logTime = log(((walk_dist/1000)/12.5)*60)
...
scenario = "lcmnl_v22.2_constraint"
...
apollo_beta = c(rep(0,length(beta_lc)),rep(0,length(beta_gv)),rep(0,5),rep(-0.1,3),rep(0,8),rep(0,5),rep(-0.1,3),rep(0,8))
...
apollo_beta = apollo_beta[names(apollo_beta) %in% c("carDav.carD_asc_c2","carDav.carD_time_c2",
                                                    "ptav.pt_asc_c1","ptav.pt_time_c1",
                                                    "bikeav.bike_asc_c1","bikeav.bike_logDistkm_c1",
                                                    "bikeav.bike_stressLink_c1","bikeav.bike_stressJctDistance_c1",
                                                    "bikeav.bike_crimeDistance_c1",
